...
### 2026-05-01T13:47:19Z — BUY AAPL 16@$282.834375 (RECONCILIATION ENTRY — logged retroactively at 10:30 intraday-scan)
- Order: market BUY filled 2026-05-01T13:47:19Z (08:47 CT, ~17 min after the 08:30 CT bell), qty=16, type=market, filled_avg_price=$282.834375, side=long.
- Cost basis: $4,525.35 → **4.64% NAV at fill** (Standard band 4-6%, sized one-notch DOWN per NFP-within-1h guardrail).
- Trail stop placed simultaneously: order **43ed6c8b-7221-419b-a8c9-9bf7d7de945c** (trailing_stop sell, qty=16, trail_percent=6%, TIF=GTC, HWM $287.22 at quote time, stop $269.9868). Native Alpaca trailing — one-way ratchet engaged.
- Reason: post-earnings PEAD on **AAPL Q2 FY26 print 04-30 AMC** (revenue $111.18B vs $109.66B est, EPS $2.01 vs $1.95, **iPhone +22% YoY, Greater China $20.5B = +28% YoY (rare reversal of multi-Q China weakness)**, Services $30.98B beat, gross margin 49.3% record, Q3 guide +14-17% YoY revenue). Stock +1.86% AH 04-30 → fill ~$282.83 = ~+4% from 04-30 close $271.06. **Pathway A pre-market WATCH queue execution** (research note in pre-market block 2026-05-01T11:27:37Z, CTQS 84/100 Standard tier).
- **RECONCILIATION**: this trade was placed by the market-open routine on 05-01 but the journal failed to commit. No 05-01 market-open entry in `runs.log` (last entry is `2026-05-01T11:30:58Z [pre-market]`), no 05-01 market-open commit in git log. The Alpaca order history is the source of truth for the fill (order id 43ed6c8b for the trail confirms execution). **Fourth journal-commit failure in 5 trading days** — surfaced as `[HARNESS-GAP]` in learnings (this run) and queued for monthly-review evolution proposal alongside the GTD-exit-at-fill remediation already pending.
- Routine: market-open (placed) → intraday-scan 10:30 (reconciled this run).
- Style/horizon: short-swing PEAD, J+0..J+5 (time stop on day J+5 = 2026-05-08 close); next earnings late July 2026 → no earnings-hold conflict.
- Status at this scan (15:36 UTC = 10:36 CT): open J+0 · mark $283.66 · +$13.13 (+0.29%) · trail engaged HWM $287.22 stop $269.99 · in-thesis. **Action this scan: HOLD** (no priority trigger, trail ratcheting natively).
